...
namespace CRM.OledbDal
{
    public class ConnDbForAcccess
    {
        ...
        {
            string connStr;
            connStr = ConfigurationManager.ConnectionStrings["AccessCRMConnStr"].ConnectionString.ToString();
            // connStr = System.Configuration.ConfigurationSettings.AppSettings["AccessCRMConnStr"].ToString(); //从web.config配置中读取
            ...
            // connectionString = System.Configuration.ConfigurationSettings.AppSettings["AccessCRMConnStr"].ToString();
            //
